...
const ISLAND_AREAS: IslandArea[] = [
  ...
  { areaNo: 'AREA-06', name: '휴식 오아시스', description: '휴식과 회복 활동이 열릴 구역입니다.', gate: 'future' },
  { areaNo: 'AREA-07', name: '시간의 모래광장', description: '시간 활동이 배치될 구역입니다.', gate: 'future' },
  { areaNo: 'AREA-08', name: '성찰 산책로', description: '돌아보기 활동이 열릴 구역입니다.', gate: 'future' },
  { areaNo: 'AREA-09', name: '목표 산', description: '목표 활동과 도전이 열릴 구역입니다.', gate: 'future' },
  { areaNo: 'AREA-10', name: '우정의 다리', description: '관계 활동이 열릴 구역입니다.', gate: 'future' },
  { areaNo: 'AREA-11', name: '창의의 샘', description: '표현 활동이 열릴 구역입니다.', gate: 'future' },
  { areaNo: 'AREA-12', name: '도전 절벽', description: '도전형 활동이 열릴 구역입니다.', gate: 'future' },
  { areaNo: 'AREA-13', name: '숙소', description: '마이룸과 휴식 기능이 정리될 구역입니다.', gate: 'always', path: '/island/lodge' },
  { areaNo: 'AREA-14', name: '성장의 정원', description: '성장 활동이 열릴 구역입니다.', gate: 'future' },
  { areaNo: 'AREA-15', name: '반성의 호수', description: '마무리 활동이 열릴 구역입니다.', gate: 'future' },
]
      ...
      <GameStage stageSx={{ px: { xs: 2.5, sm: 3 }, py: 3 }}>
        <Stack spacing={0.75} sx={{ mb: 2.5 }}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
            {sooksoClean
              ? '숙소와 항구가 열려 있습니다. 나머지 구역은 리소스와 본편 진행이 들어오면 순차적으로 열립니다.'
              : '숙소 청소가 끝나기 전에는 숙소만 열려 있습니다.'}
          </Typography>
        </Stack>
