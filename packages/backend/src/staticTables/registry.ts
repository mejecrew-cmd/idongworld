...
export const STATIC_TABLE_DEFINITIONS: StaticTableDefinition[] = [
  row({
    ...
    dependencyKeys: [
      ...
      { column: 'aidongIconId', referencesTableCode: 'X-CHR-04', referencesColumn: 'aidongIconId', optional: true },
    ],
  ...
  row({
    ...
    primaryKey: ['itemId'],
    dependencyKeys: [{ column: 'itemIconId', referencesTableCode: 'X-ITM-00', referencesColumn: 'itemIconId', optional: true }],
  ...
  row({
    ...
    category: 'aidong',
    requiredColumns: ['aidongIconId'],
    primaryKey: ['aidongIconId'],
    dependencyKeys: [{ column: 'aidongId', referencesTableCode: 'X-CHR-00', referencesColumn: 'aidongId', optional: true }],
  ...
  bundle({
    ...
    dependencyKeys: [
      { column: 'aidongId', referencesTableCode: 'X-CHR-00', referencesColumn: 'aidongId' },
  ...
  row({
    ...
    category: 'item',
    requiredColumns: ['itemIconId'],
    primaryKey: ['itemIconId'],
    dependencyKeys: [],
  ...
  row({
    ...
    dependencyKeys: [
      ...
      { column: 'itemIconId', referencesTableCode: 'X-ITM-00', referencesColumn: 'itemIconId', optional: true },
    ],
