...
import { aidongIslandRouter } from './aidong-island/routes.js'
...
import { myRoomRouter } from './myroom/routes.js'
...
backendModuleRouter.use('/myroom', myRoomRouter)
backendModuleRouter.use('/route-neighbor', routeNeighborRouter)
backendModuleRouter.use('/ship', shipRouter)
backendModuleRouter.use('/aidong-island', aidongIslandRouter)
