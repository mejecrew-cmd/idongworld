...
- 자세한 설계는 `.cloud/01_project_history_current_2026-06-13.md`를 따른다.
...
- 항해 보드 단순화 결정 자료는 `.cloud/01_project_history_current_2026-06-13.md`를 따른다.
...
- 배 적재량과 입항/비우기 사이클의 상세 기준은 `.cloud/01_project_history_current_2026-06-13.md`를 따른다.
